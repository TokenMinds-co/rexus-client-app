...
export default function EdgeItem({ label, iconUrl }: EdgeItemProps) {
  return (
    <div
      className="flex font-plus-jakarta-sans flex-col sm:flex-row text-center gap-5 items-center py-6 px-8 bg-black/70 rounded-2xl border-[1px] border-gray-500/30"
      data-aos="fade-right"
    >
